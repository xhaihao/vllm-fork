...
class Qwen3CoderToolParser(ToolParser):
    ...
    def _get_arguments_config(
            self, func_name: str,
            tools: list[ChatCompletionToolsParam] | None) -> dict:
    ...
    def _convert_param_value(self, param_value: str, param_name: str,
        ...
        elif (isinstance(param_config[param_name], dict)
              and "anyOf" in param_config[param_name]):
            # anyOf has no top-level "type";
            # treat as object to trigger json.loads.
            param_type = "object"
        else:
            param_type = "string"
    ...
    def _parse_xml_function_call(
            ...
            tools: list[ChatCompletionToolsParam] | None) -> ToolCall | None:
